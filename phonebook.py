...
class Main(tk.Frame):
    ...
    def records(self, name, tel, email):
        self.db.insert_date(name, tel, email)
        self.view_records()
    ...
    def init_main(self):
        ...
        btn_edit_dialog = tk.Button(toolbar, text="Редактировать позицию",
                                    command=self.open_update_dialog, bg='#d7d8e0', compound=tk.TOP)
        ...
        # кнопка поиска
        btn_search = tk.Button(toolbar, text="Поиск", bg='#d7d8e0',
...
class DB():
    ...
    def insert_date(self, name, tel, email):
